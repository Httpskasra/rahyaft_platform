  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="truncate text-sm font-semibold text-gray-800 dark:text-white/90">{customer.fullName}</p>
      ...
      >
        ...
        <div className="flex items-start justify-between gap-4 border-b border-gray-100 px-6 py-5 dark:border-gray-800">
          <div>
            <h3 className="text-base font-semibold text-gray-900 dark:text-white">
              {mode === "search" ? "انتخاب مشتری" : "ثبت مشتری جدید"}
            </h3>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {mode === "search" ? "نام، شماره تلفن یا کد ملی را جستجو کنید" : "اطلاعات مشتری را وارد کنید"}
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          {mode === "search" ? (
              ...
              {loading ? (
                ...
                <div className="space-y-2">
                  ...
                  <button
                    type="button"
                    onClick={() => setMode("create")}
                    className="flex w-full items-center justify-center gap-2 rounded-2xl border border-dashed border-gray-300 px-4 py-3 text-sm font-medium text-gray-500 hover:border-brand-300 hover:text-brand-600 dark:border-gray-700 dark:text-gray-400 dark:hover:border-brand-700 dark:hover:text-brand-400 transition-colors"
                  >
                    <Plus size={14} />
                    مشتری دیگری بسازید
                  </button>
            ...
            <QuickCreateForm
              initialName={looksLikePhone ? "" : search}
              initialPhone={looksLikePhone ? search : ""}
